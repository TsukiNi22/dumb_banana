...
# display   -> Boolean                  -> Display the advencement of the generation
def dumb_banana(generate, dataset, column, neuron, layer = [],
        start_variance = .1, end_variance = .1 / 100, variance_decrease = 10.0, training_round = 1000,
        bias_min = .0, bias_max = 1., coef_min = .1, coef_max = 1., k = 50.,
        display = False):
