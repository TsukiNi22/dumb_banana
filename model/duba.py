...
def dumb_banana(generate, dataset, column, neuron, layer = [], start_variance = .1, end_variance = .1 / 100, variance_decrease = 10.0, training_round = 1000, bias_min = .0, bias_max = 1., coef_min = .1, coef_max = 1.):

    # init and check the given argument
    dumb = argument_handler(generate, dataset, column, neuron, layer, start_variance, end_variance, variance_decrease, training_round, bias_min, bias_max, coef_min, coef_max)
